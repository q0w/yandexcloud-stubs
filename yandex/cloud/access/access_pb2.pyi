...
class ListAccessBindingsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        access_bindings: typing.Optional[typing.Iterable[global___AccessBinding]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class UpdateAccessBindingsRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        resource_id: typing.Text = ...,
        access_binding_deltas: typing.Optional[typing.Iterable[global___AccessBindingDelta]] = ...,
        ) -> None: ...
...
class AccessBindingDelta(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        action: global___AccessBindingAction.ValueType = ...,
        access_binding: typing.Optional[global___AccessBinding] = ...,
        ) -> None: ...
