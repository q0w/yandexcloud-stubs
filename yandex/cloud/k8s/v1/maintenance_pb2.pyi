...
class MaintenanceWindow(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["policy", b"policy"]) -> typing_extensions.Literal["anytime", "daily_maintenance_window", "weekly_maintenance_window"] | None: ...
