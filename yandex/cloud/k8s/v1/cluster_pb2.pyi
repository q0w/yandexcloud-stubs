...
class Master(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        zonal_master: typing.Optional[global___ZonalMaster] = ...,
        regional_master: typing.Optional[global___RegionalMaster] = ...,
        version: typing.Text = ...,
        endpoints: typing.Optional[global___MasterEndpoints] = ...,
        master_auth: typing.Optional[global___MasterAuth] = ...,
        version_info: typing.Optional[yandex.cloud.k8s.v1.version_pb2.VersionInfo] = ...,
        maintenance_policy: typing.Optional[global___MasterMaintenancePolicy] = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["master_type",b"master_type"]) -> typing.Optional[typing_extensions.Literal["zonal_master","regional_master"]]: ...
...
class MasterAuth(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_ca_certificate",b"cluster_ca_certificate"]) -> None: ...
...
class ZonalMaster(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["external_v4_address",b"external_v4_address","internal_v4_address",b"internal_v4_address","zone_id",b"zone_id"]) -> None: ...
...
class IPAllocationPolicy(google.protobuf.message.Message):
    ...
    service_ipv4_cidr_block: typing.Text
    """CIDR block. IP range Kubernetes service Kubernetes cluster IP addresses will be allocated from.

    It should not overlap with any subnet in the network the Kubernetes cluster located in.
    """

    cluster_ipv6_cidr_block: typing.Text
    """IPv6 range for allocating pod IP addresses."""

    service_ipv6_cidr_block: typing.Text
...
class Cilium(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["routing_mode",b"routing_mode"]) -> None: ...
