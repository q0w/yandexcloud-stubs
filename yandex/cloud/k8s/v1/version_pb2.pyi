...
class VersionInfo(google.protobuf.message.Message):
    ...
    new_revision_summary: typing.Text
    ...
    def ClearField(self, field_name: typing_extensions.Literal["current_version",b"current_version","new_revision_available",b"new_revision_available","new_revision_summary",b"new_revision_summary","version_deprecated",b"version_deprecated"]) -> None: ...
...
class UpdateVersionSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["latest_revision",b"latest_revision","specifier",b"specifier","version",b"version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["latest_revision",b"latest_revision","specifier",b"specifier","version",b"version"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["specifier",b"specifier"]) -> typing.Optional[typing_extensions.Literal["version","latest_revision"]]: ...
