...
class NetworkLoadBalancer(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        attached_target_groups: typing.Optional[typing.Iterable[global___AttachedTargetGroup]] = ...,
        ) -> None: ...
...
class AttachedTargetGroup(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        target_group_id: typing.Text = ...,
        health_checks: typing.Optional[typing.Iterable[yandex.cloud.loadbalancer.v1.health_check_pb2.HealthCheck]] = ...,
        ) -> None: ...
