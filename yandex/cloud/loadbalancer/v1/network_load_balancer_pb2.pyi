...
class NetworkLoadBalancer(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NetworkLoadBalancer._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NetworkLoadBalancer._Type.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _SessionAffinityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NetworkLoadBalancer._SessionAffinity.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class AttachedTargetGroup(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["health_checks", b"health_checks", "target_group_id", b"target_group_id"]) -> None: ...
...
class Listener(google.protobuf.message.Message):
    ...
    class _ProtocolEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Listener._Protocol.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "ip_version", b"ip_version", "name", b"name", "port", b"port", "protocol", b"protocol", "subnet_id", b"subnet_id", "target_port", b"target_port"]) -> None: ...
...
class TargetState(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TargetState._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "status", b"status", "subnet_id", b"subnet_id"]) -> None: ...
