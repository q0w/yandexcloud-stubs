...
class CreateSnapshotRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "disk_id", b"disk_id", "folder_id", b"folder_id", "labels", b"labels", "name", b"name"]) -> None: ...
...
class CreateSnapshotMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["disk_id", b"disk_id", "snapshot_id", b"snapshot_id"]) -> None: ...
...
class UpdateSnapshotRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "labels", b"labels", "name", b"name", "snapshot_id", b"snapshot_id", "update_mask", b"update_mask"]) -> None: ...
...
class ListSnapshotOperationsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["page_size", b"page_size", "page_token", b"page_token", "snapshot_id", b"snapshot_id"]) -> None: ...
