...
class DetachInstanceDiskRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["disk", b"disk"]) -> typing_extensions.Literal["disk_id", "device_name"] | None: ...
...
class DetachInstanceFilesystemRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["filesystem", b"filesystem"]) -> typing_extensions.Literal["filesystem_id", "device_name"] | None: ...
...
class AttachedDiskSpec(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["disk", b"disk"]) -> typing_extensions.Literal["disk_spec", "disk_id"] | None: ...
