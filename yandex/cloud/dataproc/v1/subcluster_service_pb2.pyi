...
class ListSubclustersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        subclusters: typing.Optional[typing.Iterable[yandex.cloud.dataproc.v1.subcluster_pb2.Subcluster]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class UpdateSubclusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["autoscaling_config",b"autoscaling_config","cluster_id",b"cluster_id","decommission_timeout",b"decommission_timeout","hosts_count",b"hosts_count","name",b"name","resources",b"resources","subcluster_id",b"subcluster_id","update_mask",b"update_mask"]) -> None: ...
