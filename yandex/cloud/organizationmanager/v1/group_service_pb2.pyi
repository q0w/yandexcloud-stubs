...
class ListGroupsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        groups: typing.Optional[typing.Iterable[yandex.cloud.organizationmanager.v1.group_pb2.Group]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateGroupRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","name",b"name","organization_id",b"organization_id"]) -> None: ...
...
class UpdateGroupRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","group_id",b"group_id","name",b"name","update_mask",b"update_mask"]) -> None: ...
...
class ListGroupMembersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        members: typing.Optional[typing.Iterable[global___GroupMember]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class UpdateGroupMembersRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        group_id: typing.Text = ...,
        member_deltas: typing.Optional[typing.Iterable[global___MemberDelta]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["group_id",b"group_id","member_deltas",b"member_deltas"]) -> None: ...
...
class MemberDelta(google.protobuf.message.Message):
    ...
    * `federatedUser`: A federated account. This type represents a user from an identity federation, like Active Directory.
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action",b"action","subject_id",b"subject_id"]) -> None: ...
