...
class ListTriggersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        triggers: typing.Optional[typing.Iterable[yandex.cloud.serverless.triggers.v1.trigger_pb2.Trigger]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateTriggerRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        rule: typing.Optional[yandex.cloud.serverless.triggers.v1.trigger_pb2.Trigger.Rule] = ...,
        ) -> None: ...
