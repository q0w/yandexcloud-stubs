...
class SendToConnectionRequest(google.protobuf.message.Message):
    ...
    class _DataTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SendToConnectionRequest._DataType.ValueType], builtins.type):  # noqa: F821
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_id", b"connection_id", "data", b"data", "type", b"type"]) -> None: ...
