...
class Connection(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["connected_at", b"connected_at", "identity", b"identity", "last_active_at", b"last_active_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["connected_at", b"connected_at", "gateway_id", b"gateway_id", "id", b"id", "identity", b"identity", "last_active_at", b"last_active_at"]) -> None: ...
...
class Identity(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["source_ip", b"source_ip", "user_agent", b"user_agent"]) -> None: ...
