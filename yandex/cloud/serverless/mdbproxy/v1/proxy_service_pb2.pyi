...
class ListProxyResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        proxies: typing.Optional[typing.Iterable[yandex.cloud.serverless.mdbproxy.v1.proxy_pb2.Proxy]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["next_page_token",b"next_page_token","proxies",b"proxies"]) -> None: ...
...
class CreateProxyRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        target: typing.Optional[yandex.cloud.serverless.mdbproxy.v1.proxy_pb2.Target] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["target",b"target"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","folder_id",b"folder_id","labels",b"labels","name",b"name","target",b"target"]) -> None: ...
...
class UpdateProxyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","labels",b"labels","name",b"name","proxy_id",b"proxy_id","target",b"target","update_mask",b"update_mask"]) -> None: ...
...
class ListProxyOperationsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","page_size",b"page_size","page_token",b"page_token","proxy_id",b"proxy_id"]) -> None: ...
