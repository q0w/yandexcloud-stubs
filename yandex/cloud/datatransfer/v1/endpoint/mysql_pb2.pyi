...
class MysqlConnection(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        mdb_cluster_id: typing.Text = ...,
        on_premise: typing.Optional[global___OnPremiseMysql] = ...,
        ) -> None: ...
...
class MysqlSource(google.protobuf.message.Message):
    ...
    def password(self) -> yandex.cloud.datatransfer.v1.endpoint.common_pb2.Secret:
        ...
        pass
    @property
    def include_tables_regex(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    @property
    def exclude_tables_regex(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    ...
    def __init__(self,
        *,
        connection: typing.Optional[global___MysqlConnection] = ...,
        ...
        include_tables_regex: typing.Optional[typing.Iterable[typing.Text]] = ...,
        exclude_tables_regex: typing.Optional[typing.Iterable[typing.Text]] = ...,
        timezone: typing.Text = ...,
        object_transfer_settings: typing.Optional[global___MysqlObjectTransferSettings] = ...,
        ) -> None: ...
