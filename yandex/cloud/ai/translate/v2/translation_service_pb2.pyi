...
class TranslateRequest(google.protobuf.message.Message):
    ...
    class _FormatEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TranslateRequest._Format.ValueType], builtins.type):  # noqa: F821
...
class TranslateGlossaryConfig(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["glossary_source", b"glossary_source"]) -> typing_extensions.Literal["glossary_data"] | None: ...
