...
class ListUsersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        users: typing.Optional[typing.Iterable[yandex.cloud.mdb.elasticsearch.v1.user_pb2.User]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateUserRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        cluster_id: typing.Text = ...,
        user_spec: typing.Optional[yandex.cloud.mdb.elasticsearch.v1.user_pb2.UserSpec] = ...,
        ) -> None: ...
