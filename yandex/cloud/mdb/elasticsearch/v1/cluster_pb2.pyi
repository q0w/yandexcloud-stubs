...
class Cluster(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        planned_operation: typing.Optional[yandex.cloud.mdb.elasticsearch.v1.maintenance_pb2.MaintenanceOperation] = ...,
        ) -> None: ...
...
class ClusterConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        version: typing.Text = ...,
        elasticsearch: typing.Optional[global___Elasticsearch] = ...,
        edition: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["elasticsearch",b"elasticsearch"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["edition",b"edition","elasticsearch",b"elasticsearch","version",b"version"]) -> None: ...
...
class Elasticsearch(google.protobuf.message.Message):
    ...
    class DataNode(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            elasticsearch_config_set_7: typing.Optional[yandex.cloud.mdb.elasticsearch.v1.config.elasticsearch_pb2.ElasticsearchConfigSet7] = ...,
            resources: typing.Optional[global___Resources] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["config",b"config","elasticsearch_config_set_7",b"elasticsearch_config_set_7","resources",b"resources"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["config",b"config"]) -> typing.Optional[typing_extensions.Literal["elasticsearch_config_set_7"]]: ...
    ...
    def __init__(self,
        *,
        data_node: typing.Optional[global___Elasticsearch.DataNode] = ...,
        master_node: typing.Optional[global___Elasticsearch.MasterNode] = ...,
...
class Host(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["resources",b"resources"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assign_public_ip",b"assign_public_ip","cluster_id",b"cluster_id","health",b"health","name",b"name","resources",b"resources","services",b"services","subnet_id",b"subnet_id","type",b"type","zone_id",b"zone_id"]) -> None: ...
global___Host = Host
