...
class RedisConfig5_0(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        notify_keyspace_events: typing.Text = ...,
        client_output_buffer_limit_pubsub: typing.Optional[global___RedisConfig5_0.ClientOutputBufferLimit] = ...,
        client_output_buffer_limit_normal: typing.Optional[global___RedisConfig5_0.ClientOutputBufferLimit] = ...,
        ) -> None: ...
...
class RedisConfigSet5_0(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        effective_config: typing.Optional[global___RedisConfig5_0] = ...,
        user_config: typing.Optional[global___RedisConfig5_0] = ...,
        default_config: typing.Optional[global___RedisConfig5_0] = ...,
        ) -> None: ...
