...
class ListDatabasesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        databases: typing.Optional[typing.Iterable[yandex.cloud.mdb.clickhouse.v1.database_pb2.Database]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateDatabaseRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        cluster_id: typing.Text = ...,
        database_spec: typing.Optional[yandex.cloud.mdb.clickhouse.v1.database_pb2.DatabaseSpec] = ...,
        ) -> None: ...
