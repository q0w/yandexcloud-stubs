...
class GetMlModelRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","ml_model_name",b"ml_model_name"]) -> None: ...
...
class ListMlModelsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ml_models: typing.Optional[typing.Iterable[yandex.cloud.mdb.clickhouse.v1.ml_model_pb2.MlModel]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["ml_models",b"ml_models","next_page_token",b"next_page_token"]) -> None: ...
...
class CreateMlModelRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","ml_model_name",b"ml_model_name","type",b"type","uri",b"uri"]) -> None: ...
...
class UpdateMlModelRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","ml_model_name",b"ml_model_name","update_mask",b"update_mask","uri",b"uri"]) -> None: ...
