...
class SQLServerConfigSet2019std(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        effective_config: typing.Optional[global___SQLServerConfig2019std] = ...,
        user_config: typing.Optional[global___SQLServerConfig2019std] = ...,
        default_config: typing.Optional[global___SQLServerConfig2019std] = ...,
        ) -> None: ...
...
class SQLServerConfigSet2019ent(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        effective_config: typing.Optional[global___SQLServerConfig2019ent] = ...,
        user_config: typing.Optional[global___SQLServerConfig2019ent] = ...,
        default_config: typing.Optional[global___SQLServerConfig2019ent] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["default_config",b"default_config","effective_config",b"effective_config","user_config",b"user_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_config",b"default_config","effective_config",b"effective_config","user_config",b"user_config"]) -> None: ...
