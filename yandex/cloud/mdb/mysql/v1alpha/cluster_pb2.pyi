...
class Cluster(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","created_at",b"created_at","description",b"description","environment",b"environment","folder_id",b"folder_id","health",b"health","id",b"id","labels",b"labels","monitoring",b"monitoring","name",b"name","network_id",b"network_id","status",b"status"]) -> None: ...
...
class ClusterConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        version: typing.Text = ...,
        mysql_config_5_7: typing.Optional[yandex.cloud.mdb.mysql.v1alpha.config.mysql5_7_pb2.MysqlConfigSet5_7] = ...,
