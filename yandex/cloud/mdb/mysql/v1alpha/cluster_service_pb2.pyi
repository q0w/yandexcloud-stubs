...
class ListClustersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        clusters: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1alpha.cluster_pb2.Cluster]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateClusterRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        database_specs: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1alpha.database_pb2.DatabaseSpec]] = ...,
        user_specs: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1alpha.user_pb2.UserSpec]] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config_spec",b"config_spec","database_specs",b"database_specs","description",b"description","environment",b"environment","folder_id",b"folder_id","host_specs",b"host_specs","labels",b"labels","name",b"name","network_id",b"network_id","user_specs",b"user_specs"]) -> None: ...
...
class UpdateClusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","config_spec",b"config_spec","description",b"description","labels",b"labels","name",b"name","update_mask",b"update_mask"]) -> None: ...
...
class RestoreClusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_id",b"backup_id","config_spec",b"config_spec","description",b"description","environment",b"environment","host_specs",b"host_specs","labels",b"labels","name",b"name","network_id",b"network_id","time",b"time"]) -> None: ...
...
class ListClusterBackupsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        backups: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1alpha.backup_pb2.Backup]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class ListClusterHostsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        hosts: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1alpha.cluster_pb2.Host]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class ConfigSpec(google.protobuf.message.Message):
    ...
    * 5.7
    ...
    def __init__(self,
        *,
        version: typing.Text = ...,
        mysql_config_5_7: typing.Optional[yandex.cloud.mdb.mysql.v1alpha.config.mysql5_7_pb2.MysqlConfig5_7] = ...,
        resources: typing.Optional[yandex.cloud.mdb.mysql.v1alpha.cluster_pb2.Resources] = ...,
        backup_window_start: typing.Optional[google.type.timeofday_pb2.TimeOfDay] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["backup_window_start",b"backup_window_start","mysql_config",b"mysql_config","mysql_config_5_7",b"mysql_config_5_7","resources",b"resources"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_window_start",b"backup_window_start","mysql_config",b"mysql_config","mysql_config_5_7",b"mysql_config_5_7","resources",b"resources","version",b"version"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["mysql_config",b"mysql_config"]) -> typing.Optional[typing_extensions.Literal["mysql_config_5_7"]]: ...
