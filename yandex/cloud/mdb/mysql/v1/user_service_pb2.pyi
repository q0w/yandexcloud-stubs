...
class ListUsersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        users: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1.user_pb2.User]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateUserRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        cluster_id: typing.Text = ...,
        user_spec: typing.Optional[yandex.cloud.mdb.mysql.v1.user_pb2.UserSpec] = ...,
        ) -> None: ...
...
class UpdateUserRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        password: typing.Text = ...,
        permissions: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1.user_pb2.Permission]] = ...,
        global_permissions: typing.Optional[typing.Iterable[yandex.cloud.mdb.mysql.v1.user_pb2.GlobalPermission.ValueType]] = ...,
        connection_limits: typing.Optional[yandex.cloud.mdb.mysql.v1.user_pb2.ConnectionLimits] = ...,
        authentication_plugin: yandex.cloud.mdb.mysql.v1.user_pb2.AuthPlugin.ValueType = ...,
        ) -> None: ...
...
class GrantUserPermissionRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        cluster_id: typing.Text = ...,
        user_name: typing.Text = ...,
        permission: typing.Optional[yandex.cloud.mdb.mysql.v1.user_pb2.Permission] = ...,
        ) -> None: ...
