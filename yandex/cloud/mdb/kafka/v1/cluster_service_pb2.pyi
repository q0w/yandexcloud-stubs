...
class ListClustersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        clusters: typing.Optional[typing.Iterable[yandex.cloud.mdb.kafka.v1.cluster_pb2.Cluster]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class CreateClusterRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        environment: yandex.cloud.mdb.kafka.v1.cluster_pb2.Cluster.Environment.ValueType = ...,
        config_spec: typing.Optional[yandex.cloud.mdb.kafka.v1.cluster_pb2.ConfigSpec] = ...,
        topic_specs: typing.Optional[typing.Iterable[yandex.cloud.mdb.kafka.v1.topic_pb2.TopicSpec]] = ...,
        user_specs: typing.Optional[typing.Iterable[yandex.cloud.mdb.kafka.v1.user_pb2.UserSpec]] = ...,
        network_id: typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config_spec",b"config_spec","deletion_protection",b"deletion_protection","description",b"description","environment",b"environment","folder_id",b"folder_id","host_group_ids",b"host_group_ids","labels",b"labels","maintenance_window",b"maintenance_window","name",b"name","network_id",b"network_id","security_group_ids",b"security_group_ids","subnet_id",b"subnet_id","topic_specs",b"topic_specs","user_specs",b"user_specs"]) -> None: ...
...
class ListClusterLogsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["always_next_page_token",b"always_next_page_token","cluster_id",b"cluster_id","column_filter",b"column_filter","filter",b"filter","from_time",b"from_time","page_size",b"page_size","page_token",b"page_token","to_time",b"to_time"]) -> None: ...
...
class StreamClusterLogsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["from_time",b"from_time","to_time",b"to_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","column_filter",b"column_filter","filter",b"filter","from_time",b"from_time","record_token",b"record_token","to_time",b"to_time"]) -> None: ...
...
class ListClusterHostsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        hosts: typing.Optional[typing.Iterable[yandex.cloud.mdb.kafka.v1.cluster_pb2.Host]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
