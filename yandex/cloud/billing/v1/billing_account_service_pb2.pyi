...
class ListBillingAccountsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        billing_accounts: typing.Optional[typing.Iterable[yandex.cloud.billing.v1.billing_account_pb2.BillingAccount]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class ListBillableObjectBindingsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        billable_object_bindings: typing.Optional[typing.Iterable[yandex.cloud.billing.v1.billable_object_pb2.BillableObjectBinding]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["billable_object_bindings",b"billable_object_bindings","next_page_token",b"next_page_token"]) -> None: ...
...
class BindBillableObjectRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        billing_account_id: typing.Text = ...,
        billable_object: typing.Optional[yandex.cloud.billing.v1.billable_object_pb2.BillableObject] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["billable_object",b"billable_object"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["billable_object",b"billable_object","billing_account_id",b"billing_account_id"]) -> None: ...
...
class BindBillableObjectMetadata(google.protobuf.message.Message):
    ...
    billable_object_id: typing.Text
    ...
    def ClearField(self, field_name: typing_extensions.Literal["billable_object_id",b"billable_object_id"]) -> None: ...
