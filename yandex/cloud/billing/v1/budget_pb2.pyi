...
class Budget(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["budget_spec", b"budget_spec"]) -> typing_extensions.Literal["cost_budget", "expense_budget", "balance_budget"] | None: ...
...
class CostBudgetSpec(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["start_type", b"start_type"]) -> typing_extensions.Literal["reset_period", "start_date"] | None: ...
