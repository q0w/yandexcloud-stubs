...
class CreateBudgetRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["budget_spec", b"budget_spec"]) -> typing_extensions.Literal["cost_budget_spec", "expense_budget_spec", "balance_budget_spec"] | None: ...
