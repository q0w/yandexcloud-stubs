...
class UploadFileRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        metadata: typing.Optional[global___FileMetadata] = ...,
        chunk: builtins.bytes = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["message",b"message"]) -> typing.Optional[typing_extensions.Literal["metadata","chunk"]]: ...
