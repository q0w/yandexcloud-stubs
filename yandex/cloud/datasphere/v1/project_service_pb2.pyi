...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        name: typing.Text = ...,
        description: typing.Text = ...,
        settings: typing.Optional[yandex.cloud.datasphere.v1.project_pb2.Project.Settings] = ...,
        limits: typing.Optional[yandex.cloud.datasphere.v1.project_pb2.Project.Limits] = ...,
        ) -> None: ...
...
class ListProjectsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        projects: typing.Optional[typing.Iterable[yandex.cloud.datasphere.v1.project_pb2.Project]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class ProjectExecutionRequest(google.protobuf.message.Message):
    ...
    def input_variables(self) -> google.protobuf.struct_pb2.Struct:
        ...
        pass
    @property
    def output_variable_names(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        notebook_id: typing.Text = ...,
        cell_id: typing.Text = ...,
        input_variables: typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        output_variable_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target",b"target"]) -> typing.Optional[typing_extensions.Literal["notebook_id","cell_id"]]: ...
...
class ProjectExecutionResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        checkpoint_id: typing.Text = ...,
        output_variables: typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        ) -> None: ...
...
class GetStateVariablesRequest(google.protobuf.message.Message):
    ...
    @property
    def variable_names(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        project_id: typing.Text = ...,
        notebook_id: typing.Text = ...,
        variable_names: typing.Optional[typing.Iterable[typing.Text]] = ...,
        checkpoint_id: typing.Text = ...,
        ) -> None: ...
...
class GetStateVariablesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        variables: typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        ) -> None: ...
...
class GetNotebookMetadataResponse(google.protobuf.message.Message):
    ...
    @property
    def cell_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        content_length: builtins.int = ...,
        cell_ids: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
