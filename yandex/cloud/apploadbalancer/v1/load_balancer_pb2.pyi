...
class LoadBalancer(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[LoadBalancer._Status.ValueType], builtins.type):  # noqa: F821
...
class Address(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["address", b"address"]) -> typing_extensions.Literal["external_ipv4_address", "internal_ipv4_address", "external_ipv6_address"] | None: ...
...
class HttpHandler(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["protocol_settings", b"protocol_settings"]) -> typing_extensions.Literal["http2_options", "allow_http10"] | None: ...
...
class TlsHandler(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["handler", b"handler"]) -> typing_extensions.Literal["http_handler", "stream_handler"] | None: ...
