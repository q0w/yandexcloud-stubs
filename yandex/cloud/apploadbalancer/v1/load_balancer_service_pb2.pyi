...
class AddressSpec(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["address_spec", b"address_spec"]) -> typing_extensions.Literal["external_ipv4_address_spec", "internal_ipv4_address_spec", "external_ipv6_address_spec"] | None: ...
...
class ListenerSpec(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["listener", b"listener"]) -> typing_extensions.Literal["http", "tls", "stream"] | None: ...
