...
class GetLoadBalancerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["load_balancer_id",b"load_balancer_id"]) -> None: ...
...
class ListLoadBalancersResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        load_balancers: typing.Optional[typing.Iterable[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.LoadBalancer]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["load_balancers",b"load_balancers","next_page_token",b"next_page_token"]) -> None: ...
...
class UpdateLoadBalancerRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        allocation_policy: typing.Optional[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.AllocationPolicy] = ...,
...
class AddListenerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["listener_spec",b"listener_spec","load_balancer_id",b"load_balancer_id"]) -> None: ...
...
class AddListenerMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["listener_name",b"listener_name","load_balancer_id",b"load_balancer_id"]) -> None: ...
...
class RemoveListenerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["load_balancer_id",b"load_balancer_id","name",b"name"]) -> None: ...
...
class UpdateListenerRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["listener_spec",b"listener_spec","update_mask",b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["listener_spec",b"listener_spec","load_balancer_id",b"load_balancer_id","update_mask",b"update_mask"]) -> None: ...
...
class AddressSpec(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        internal_ipv4_address_spec: typing.Optional[global___InternalIpv4AddressSpec] = ...,
        external_ipv6_address_spec: typing.Optional[global___ExternalIpv6AddressSpec] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["address_spec",b"address_spec","external_ipv4_address_spec",b"external_ipv4_address_spec","external_ipv6_address_spec",b"external_ipv6_address_spec","internal_ipv4_address_spec",b"internal_ipv4_address_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_spec",b"address_spec","external_ipv4_address_spec",b"external_ipv4_address_spec","external_ipv6_address_spec",b"external_ipv6_address_spec","internal_ipv4_address_spec",b"internal_ipv4_address_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["address_spec",b"address_spec"]) -> typing.Optional[typing_extensions.Literal["external_ipv4_address_spec","internal_ipv4_address_spec","external_ipv6_address_spec"]]: ...
...
class EndpointSpec(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        address_specs: typing.Optional[typing.Iterable[global___AddressSpec]] = ...,
        ports: typing.Optional[typing.Iterable[builtins.int]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_specs",b"address_specs","ports",b"ports"]) -> None: ...
...
class ListenerSpec(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        name: typing.Text = ...,
        endpoint_specs: typing.Optional[typing.Iterable[global___EndpointSpec]] = ...,
        http: typing.Optional[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.HttpListener] = ...,
        tls: typing.Optional[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.TlsListener] = ...,
        stream: typing.Optional[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.StreamListener] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["endpoint_specs",b"endpoint_specs","http",b"http","listener",b"listener","name",b"name","stream",b"stream","tls",b"tls"]) -> None: ...
...
class GetTargetStatesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["backend_group_id",b"backend_group_id","load_balancer_id",b"load_balancer_id","target_group_id",b"target_group_id"]) -> None: ...
...
class GetTargetStatesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        target_states: typing.Optional[typing.Iterable[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.TargetState]] = ...,
        ) -> None: ...
...
class AddSniMatchRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        handler: typing.Optional[yandex.cloud.apploadbalancer.v1.load_balancer_pb2.TlsHandler] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["handler",b"handler"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["handler",b"handler","listener_name",b"listener_name","load_balancer_id",b"load_balancer_id","name",b"name","server_names",b"server_names"]) -> None: ...
...
class AddSniMatchMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["listener_name",b"listener_name","load_balancer_id",b"load_balancer_id","sni_match_name",b"sni_match_name"]) -> None: ...
...
class UpdateSniMatchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["handler",b"handler","update_mask",b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["handler",b"handler","listener_name",b"listener_name","load_balancer_id",b"load_balancer_id","name",b"name","server_names",b"server_names","update_mask",b"update_mask"]) -> None: ...
...
class ListLoadBalancerOperationsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["load_balancer_id",b"load_balancer_id","page_size",b"page_size","page_token",b"page_token"]) -> None: ...
