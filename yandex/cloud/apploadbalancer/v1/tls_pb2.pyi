...
class ValidationContext(google.protobuf.message.Message):
    ...
    trusted_ca_id: typing.Text
    trusted_ca_bytes: typing.Text
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["trusted_ca",b"trusted_ca"]) -> typing.Optional[typing_extensions.Literal["trusted_ca_id","trusted_ca_bytes"]]: ...
