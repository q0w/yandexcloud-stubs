...
class CreateVirtualHostRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        routes: typing.Optional[typing.Iterable[yandex.cloud.apploadbalancer.v1.virtual_host_pb2.Route]] = ...,
        modify_request_headers: typing.Optional[typing.Iterable[yandex.cloud.apploadbalancer.v1.virtual_host_pb2.HeaderModification]] = ...,
        modify_response_headers: typing.Optional[typing.Iterable[yandex.cloud.apploadbalancer.v1.virtual_host_pb2.HeaderModification]] = ...,
        ) -> None: ...
...
class UpdateRouteRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        route_name: typing.Text = ...,
        update_mask: typing.Optional[google.protobuf.field_mask_pb2.FieldMask] = ...,
        http: typing.Optional[yandex.cloud.apploadbalancer.v1.virtual_host_pb2.HttpRoute] = ...,
        grpc: typing.Optional[yandex.cloud.apploadbalancer.v1.virtual_host_pb2.GrpcRoute] = ...,
        ) -> None: ...
