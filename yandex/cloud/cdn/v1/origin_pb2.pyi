...
class Origin(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        enabled: builtins.bool = ...,
        backup: builtins.bool = ...,
        meta: typing.Optional[global___OriginMeta] = ...,
        ) -> None: ...
...
class OriginMeta(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        common: typing.Optional[global___OriginNamedMeta] = ...,
        bucket: typing.Optional[global___OriginNamedMeta] = ...,
        website: typing.Optional[global___OriginNamedMeta] = ...,
        balancer: typing.Optional[global___OriginBalancerMeta] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["origin_meta_variant",b"origin_meta_variant"]) -> typing.Optional[typing_extensions.Literal["common","bucket","website","balancer"]]: ...
