...
class RawLogsSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bucket_name",b"bucket_name","bucket_region",b"bucket_region","file_prefix",b"file_prefix"]) -> None: ...
