...
class SSLCertificateData(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["ssl_certificate_data_variant", b"ssl_certificate_data_variant"]) -> typing_extensions.Literal["cm"] | None: ...
