...
class Resource(google.protobuf.message.Message):
    ...
    def options(self) -> global___ResourceOptions:
        ...
        pass
    @property
    def secondary_hostnames(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        """List of secondary hostname strings."""
        pass
    origin_group_id: builtins.int
    """ID of the origin group."""

    origin_group_name: typing.Text
    ...
    def __init__(self,
        *,
        ...
        active: builtins.bool = ...,
        options: typing.Optional[global___ResourceOptions] = ...,
        secondary_hostnames: typing.Optional[typing.Iterable[typing.Text]] = ...,
        origin_group_id: builtins.int = ...,
        origin_group_name: typing.Text = ...,
        origin_protocol: global___OriginProtocol.ValueType = ...,
        ssl_certificate: typing.Optional[global___SSLCertificate] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["created_at",b"created_at","options",b"options","ssl_certificate",b"ssl_certificate","updated_at",b"updated_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["active",b"active","cname",b"cname","created_at",b"created_at","folder_id",b"folder_id","id",b"id","options",b"options","origin_group_id",b"origin_group_id","origin_group_name",b"origin_group_name","origin_protocol",b"origin_protocol","secondary_hostnames",b"secondary_hostnames","ssl_certificate",b"ssl_certificate","updated_at",b"updated_at"]) -> None: ...
...
class ResourceOptions(google.protobuf.message.Message):
    ...
    class CachingTimes(google.protobuf.message.Message):
        ...
        @property
        def custom_values(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, builtins.int]:
        ...
        def __init__(self,
            *,
            simple_value: builtins.int = ...,
            custom_values: typing.Optional[typing.Mapping[typing.Text, builtins.int]] = ...,
            ) -> None: ...
    ...
    class EdgeCacheSettings(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            enabled: builtins.bool = ...,
            value: typing.Optional[global___ResourceOptions.CachingTimes] = ...,
            default_value: builtins.int = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["default_value",b"default_value","value",b"value","values_variant",b"values_variant"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["values_variant",b"values_variant"]) -> typing.Optional[typing_extensions.Literal["value","default_value"]]: ...
    ...
    class StringVariableMapOption(google.protobuf.message.Message):
        ...
        class OneofString(google.protobuf.message.Message):
            ...
            def __init__(self,
                *,
                value: typing.Optional[global___ResourceOptions.StringOption] = ...,
                values: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
                ) -> None: ...
            def HasField(self, field_name: typing_extensions.Literal["string_option",b"string_option","value",b"value","values",b"values"]) -> builtins.bool: ...
            ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["string_option",b"string_option"]) -> typing.Optional[typing_extensions.Literal["value","values"]]: ...
        ...
        class ValueEntry(google.protobuf.message.Message):
            ...
            def __init__(self,
                *,
                key: typing.Text = ...,
                value: typing.Optional[global___ResourceOptions.StringVariableMapOption.OneofString] = ...,
                ) -> None: ...
        ...
        @property
        def value(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___ResourceOptions.StringVariableMapOption.OneofString]:
            """Value of the option."""
            pass
        def __init__(self,
            *,
            enabled: builtins.bool = ...,
            value: typing.Optional[typing.Mapping[typing.Text, global___ResourceOptions.StringVariableMapOption.OneofString]] = ...,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["enabled",b"enabled","value",b"value"]) -> None: ...
    ...
    class QueryParamsOptions(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            ignore_query_string: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            query_params_whitelist: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
            query_params_blacklist: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["ignore_query_string",b"ignore_query_string","query_params_blacklist",b"query_params_blacklist","query_params_variant",b"query_params_variant","query_params_whitelist",b"query_params_whitelist"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["query_params_variant",b"query_params_variant"]) -> typing.Optional[typing_extensions.Literal["ignore_query_string","query_params_whitelist","query_params_blacklist"]]: ...
    ...
    class RedirectOptions(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            redirect_http_to_https: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            redirect_https_to_http: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["redirect_http_to_https",b"redirect_http_to_https","redirect_https_to_http",b"redirect_https_to_http","redirect_variant",b"redirect_variant"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["redirect_variant",b"redirect_variant"]) -> typing.Optional[typing_extensions.Literal["redirect_http_to_https","redirect_https_to_http"]]: ...
    ...
    class HostOptions(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            host: typing.Optional[global___ResourceOptions.StringOption] = ...,
            forward_host_header: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["forward_host_header",b"forward_host_header","host",b"host","host_variant",b"host_variant"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["host_variant",b"host_variant"]) -> typing.Optional[typing_extensions.Literal["host","forward_host_header"]]: ...
    ...
    class CompressionOptions(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            fetch_compressed: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            gzip_on: typing.Optional[global___ResourceOptions.BoolOption] = ...,
            brotli_compression: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["brotli_compression",b"brotli_compression","compression_variant",b"compression_variant","fetch_compressed",b"fetch_compressed","gzip_on",b"gzip_on"]) -> builtins.bool: ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["compression_variant",b"compression_variant"]) -> typing.Optional[typing_extensions.Literal["fetch_compressed","gzip_on","brotli_compression"]]: ...
    ...
    class RewriteOption(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["body",b"body","enabled",b"enabled","flag",b"flag"]) -> None: ...
    ...
    def __init__(self,
        *,
        disable_cache: typing.Optional[global___ResourceOptions.BoolOption] = ...,
        edge_cache_settings: typing.Optional[global___ResourceOptions.EdgeCacheSettings] = ...,
        browser_cache_settings: typing.Optional[global___ResourceOptions.Int64Option] = ...,
        cache_http_headers: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
        query_params_options: typing.Optional[global___ResourceOptions.QueryParamsOptions] = ...,
        slice: typing.Optional[global___ResourceOptions.BoolOption] = ...,
        compression_options: typing.Optional[global___ResourceOptions.CompressionOptions] = ...,
        redirect_options: typing.Optional[global___ResourceOptions.RedirectOptions] = ...,
        host_options: typing.Optional[global___ResourceOptions.HostOptions] = ...,
        static_headers: typing.Optional[global___ResourceOptions.StringsMapOption] = ...,
        cors: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
        stale: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
        allowed_http_methods: typing.Optional[global___ResourceOptions.StringsListOption] = ...,
        proxy_cache_methods_set: typing.Optional[global___ResourceOptions.BoolOption] = ...,
        disable_proxy_force_ranges: typing.Optional[global___ResourceOptions.BoolOption] = ...,
        static_request_headers: typing.Optional[global___ResourceOptions.StringsMapOption] = ...,
        custom_server_name: typing.Optional[global___ResourceOptions.StringOption] = ...,
        ignore_cookie: typing.Optional[global___ResourceOptions.BoolOption] = ...,
        rewrite: typing.Optional[global___ResourceOptions.RewriteOption] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["allowed_http_methods",b"allowed_http_methods","browser_cache_settings",b"browser_cache_settings","cache_http_headers",b"cache_http_headers","compression_options",b"compression_options","cors",b"cors","custom_server_name",b"custom_server_name","disable_cache",b"disable_cache","disable_proxy_force_ranges",b"disable_proxy_force_ranges","edge_cache_settings",b"edge_cache_settings","host_options",b"host_options","ignore_cookie",b"ignore_cookie","proxy_cache_methods_set",b"proxy_cache_methods_set","query_params_options",b"query_params_options","redirect_options",b"redirect_options","rewrite",b"rewrite","slice",b"slice","stale",b"stale","static_headers",b"static_headers","static_request_headers",b"static_request_headers"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["allowed_http_methods",b"allowed_http_methods","browser_cache_settings",b"browser_cache_settings","cache_http_headers",b"cache_http_headers","compression_options",b"compression_options","cors",b"cors","custom_server_name",b"custom_server_name","disable_cache",b"disable_cache","disable_proxy_force_ranges",b"disable_proxy_force_ranges","edge_cache_settings",b"edge_cache_settings","host_options",b"host_options","ignore_cookie",b"ignore_cookie","proxy_cache_methods_set",b"proxy_cache_methods_set","query_params_options",b"query_params_options","redirect_options",b"redirect_options","rewrite",b"rewrite","slice",b"slice","stale",b"stale","static_headers",b"static_headers","static_request_headers",b"static_request_headers"]) -> None: ...
...
class SSLTargetCertificate(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        type: global___SSLCertificateType.ValueType = ...,
        data: typing.Optional[global___SSLCertificateData] = ...,
        ) -> None: ...
...
class SSLCertificate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","status",b"status","type",b"type"]) -> None: ...
...
class SSLCertificateData(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        cm: typing.Optional[global___SSLCertificateCMData] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cm",b"cm","ssl_certificate_data_variant",b"ssl_certificate_data_variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cm",b"cm","ssl_certificate_data_variant",b"ssl_certificate_data_variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["ssl_certificate_data_variant",b"ssl_certificate_data_variant"]) -> typing.Optional[typing_extensions.Literal["cm"]]: ...
