...
class GetLifecyclePolicyRequest(google.protobuf.message.Message):
    ...
    lifecycle_policy_id: typing.Text
    ...
    def ClearField(self, field_name: typing_extensions.Literal["lifecycle_policy_id",b"lifecycle_policy_id"]) -> None: ...
...
class ListLifecyclePoliciesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id",b"id","registry_id",b"registry_id","repository_id",b"repository_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","id",b"id","order_by",b"order_by","page_size",b"page_size","page_token",b"page_token","registry_id",b"registry_id","repository_id",b"repository_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["id",b"id"]) -> typing.Optional[typing_extensions.Literal["registry_id","repository_id"]]: ...
...
class ListLifecyclePoliciesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        lifecycle_policies: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.lifecycle_policy_pb2.LifecyclePolicy]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["lifecycle_policies",b"lifecycle_policies","next_page_token",b"next_page_token"]) -> None: ...
...
class CreateLifecyclePolicyRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        description: typing.Text = ...,
        status: yandex.cloud.containerregistry.v1.lifecycle_policy_pb2.LifecyclePolicy.Status.ValueType = ...,
        rules: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.lifecycle_policy_pb2.LifecycleRule]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","name",b"name","repository_id",b"repository_id","rules",b"rules","status",b"status"]) -> None: ...
...
class UpdateLifecyclePolicyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","lifecycle_policy_id",b"lifecycle_policy_id","name",b"name","rules",b"rules","status",b"status","update_mask",b"update_mask"]) -> None: ...
...
class DryRunLifecyclePolicyMetadata(google.protobuf.message.Message):
    ...
    LIFECYCLE_POLICY_ID_FIELD_NUMBER: builtins.int
    dry_run_lifecycle_policy_result_id: typing.Text
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dry_run_lifecycle_policy_result_id",b"dry_run_lifecycle_policy_result_id","lifecycle_policy_id",b"lifecycle_policy_id"]) -> None: ...
...
class DryRunLifecyclePolicyResult(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        dry_run_lifecycle_policy_result_id: typing.Text = ...,
        lifecycle_policy_id: typing.Text = ...,
        run_at: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        affected_images_count: builtins.int = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["run_at",b"run_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["affected_images_count",b"affected_images_count","dry_run_lifecycle_policy_result_id",b"dry_run_lifecycle_policy_result_id","lifecycle_policy_id",b"lifecycle_policy_id","run_at",b"run_at"]) -> None: ...
...
class GetDryRunLifecyclePolicyResultRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dry_run_lifecycle_policy_result_id",b"dry_run_lifecycle_policy_result_id"]) -> None: ...
...
class ListDryRunLifecyclePolicyResultsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","lifecycle_policy_id",b"lifecycle_policy_id","order_by",b"order_by","page_size",b"page_size","page_token",b"page_token"]) -> None: ...
...
class ListDryRunLifecyclePolicyResultsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        dry_run_lifecycle_policy_results: typing.Optional[typing.Iterable[global___DryRunLifecyclePolicyResult]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["dry_run_lifecycle_policy_results",b"dry_run_lifecycle_policy_results","next_page_token",b"next_page_token"]) -> None: ...
...
class ListDryRunLifecyclePolicyResultAffectedImagesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dry_run_lifecycle_policy_result_id",b"dry_run_lifecycle_policy_result_id","filter",b"filter","order_by",b"order_by","page_size",b"page_size","page_token",b"page_token"]) -> None: ...
...
class ListDryRunLifecyclePolicyResultAffectedImagesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        affected_images: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.image_pb2.Image]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["affected_images",b"affected_images","next_page_token",b"next_page_token"]) -> None: ...
