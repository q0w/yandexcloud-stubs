...
class ListScanResultsRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["id",b"id"]) -> typing.Optional[typing_extensions.Literal["image_id","repository_id"]]: ...
...
class ListScanResultsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        scan_results: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.scanner_pb2.ScanResult]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
...
class ListVulnerabilitiesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        vulnerabilities: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.scanner_pb2.Vulnerability]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
