...
class ScanResult(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ScanResult._Status.ValueType], builtins.type):  # noqa: F821
...
class Vulnerability(google.protobuf.message.Message):
    ...
    class _SeverityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Vulnerability._Severity.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["vulnerability", b"vulnerability"]) -> typing_extensions.Literal["package"] | None: ...
