...
class ListImagesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","folder_id",b"folder_id","order_by",b"order_by","page_size",b"page_size","page_token",b"page_token","registry_id",b"registry_id","repository_name",b"repository_name"]) -> None: ...
...
class ListImagesResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        images: typing.Optional[typing.Iterable[yandex.cloud.containerregistry.v1.image_pb2.Image]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
