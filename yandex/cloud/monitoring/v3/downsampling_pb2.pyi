...
class Downsampling(google.protobuf.message.Message):
    ...
    class _GridAggregationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Downsampling._GridAggregation.ValueType], builtins.type):  # noqa: F821
    ...
    class _GapFillingEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Downsampling._GapFilling.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(self, field_name: typing_extensions.Literal["disabled", b"disabled", "grid_interval", b"grid_interval", "max_points", b"max_points", "mode", b"mode"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["disabled", b"disabled", "gap_filling", b"gap_filling", "grid_aggregation", b"grid_aggregation", "grid_interval", b"grid_interval", "max_points", b"max_points", "mode", b"mode"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["mode", b"mode"]) -> typing_extensions.Literal["max_points", "grid_interval", "disabled"] | None: ...
