...
class Parameter(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data", b"data"]) -> typing_extensions.Literal["label_values", "custom", "text", "integer_parameter", "double_parameter", "text_values"] | None: ...
