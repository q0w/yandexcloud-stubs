...
class TitleWidget(google.protobuf.message.Message):
    ...
    class _TitleSizeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[TitleWidget._TitleSize.ValueType], builtins.type):  # noqa: F821
    ...
    def ClearField(self, field_name: typing_extensions.Literal["size", b"size", "text", b"text"]) -> None: ...
