...
class Database(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Database._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["database_type", b"database_type"]) -> typing_extensions.Literal["zonal_database", "regional_database", "dedicated_database", "serverless_database"] | None: ...
...
class AlertParameter(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["parameter", b"parameter"]) -> typing_extensions.Literal["double_parameter_value", "integer_parameter_value", "text_parameter_value", "text_list_parameter_value", "label_list_parameter_value"] | None: ...
