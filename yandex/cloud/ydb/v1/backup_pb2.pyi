...
class BackupSchedule(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        daily_backup_schedule: typing.Optional[global___DailyBackupSchedule] = ...,
        weekly_backup_schedule: typing.Optional[global___WeeklyBackupSchedule] = ...,
        recurring_backup_schedule: typing.Optional[global___RecurringBackupSchedule] = ...,
        next_execute_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["daily_backup_schedule",b"daily_backup_schedule","next_execute_time",b"next_execute_time","policy",b"policy","recurring_backup_schedule",b"recurring_backup_schedule","weekly_backup_schedule",b"weekly_backup_schedule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["daily_backup_schedule",b"daily_backup_schedule","next_execute_time",b"next_execute_time","policy",b"policy","recurring_backup_schedule",b"recurring_backup_schedule","weekly_backup_schedule",b"weekly_backup_schedule"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["policy",b"policy"]) -> typing.Optional[typing_extensions.Literal["daily_backup_schedule","weekly_backup_schedule","recurring_backup_schedule"]]: ...
...
class RecurringBackupSchedule(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["recurrence",b"recurrence","start_time",b"start_time"]) -> None: ...
...
class DaysOfWeekBackupSchedule(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        execute_time: typing.Optional[google.type.timeofday_pb2.TimeOfDay] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["execute_time",b"execute_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["days",b"days","execute_time",b"execute_time"]) -> None: ...
...
class WeeklyBackupSchedule(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        days_of_week: typing.Optional[typing.Iterable[global___DaysOfWeekBackupSchedule]] = ...,
        ) -> None: ...
...
class BackupSettings(google.protobuf.message.Message):
    ...
    def source_paths(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        ...
        pass
    @property
    def source_paths_to_exclude(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        name: typing.Text = ...,
        description: typing.Text = ...,
        backup_schedule: typing.Optional[global___BackupSchedule] = ...,
        backup_time_to_live: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        source_paths: typing.Optional[typing.Iterable[typing.Text]] = ...,
        source_paths_to_exclude: typing.Optional[typing.Iterable[typing.Text]] = ...,
        type: global___BackupSettings.Type.ValueType = ...,
        storage_class: global___BackupSettings.StorageClass.ValueType = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["backup_schedule",b"backup_schedule","backup_time_to_live",b"backup_time_to_live"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_schedule",b"backup_schedule","backup_time_to_live",b"backup_time_to_live","description",b"description","name",b"name","source_paths",b"source_paths","source_paths_to_exclude",b"source_paths_to_exclude","storage_class",b"storage_class","type",b"type"]) -> None: ...
...
class BackupConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        backup_settings: typing.Optional[typing.Iterable[global___BackupSettings]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_settings",b"backup_settings"]) -> None: ...
...
class Backup(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        status: global___Backup.Status.ValueType = ...,
        backup_settings: typing.Optional[global___BackupSettings] = ...,
        type: global___Backup.Type.ValueType = ...,
        size: builtins.int = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["backup_settings",b"backup_settings","completed_at",b"completed_at","created_at",b"created_at","started_at",b"started_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_settings",b"backup_settings","completed_at",b"completed_at","created_at",b"created_at","database_id",b"database_id","description",b"description","folder_id",b"folder_id","id",b"id","name",b"name","size",b"size","started_at",b"started_at","status",b"status","type",b"type"]) -> None: ...
