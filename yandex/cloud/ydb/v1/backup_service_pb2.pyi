...
class ListPathsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["backup_id",b"backup_id","page_size",b"page_size","page_token",b"page_token"]) -> None: ...
...
class ListPathsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["next_page_token",b"next_page_token","paths",b"paths"]) -> None: ...
...
class ListBackupsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        backups: typing.Optional[typing.Iterable[yandex.cloud.ydb.v1.backup_pb2.Backup]] = ...,
        next_page_token: typing.Text = ...,
        ) -> None: ...
